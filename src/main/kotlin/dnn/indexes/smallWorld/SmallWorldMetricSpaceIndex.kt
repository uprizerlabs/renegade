 ...
 * property, which should facilitate fast dnn.indexes.
 *
 * Search is performed through greedy best-first with backtracking.  It is not guaranteed to find the closest element,
 * but it should in most cases.  The dnn.indexes returns a lazy [Sequence] of item results, which will get steadily
